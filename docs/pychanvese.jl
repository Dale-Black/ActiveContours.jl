...
using Images, TestImages, PlutoUI, Statistics, CairoMakie
...
# ╔═╡ e055d951-9cbd-45ee-acc9-ad1d61a0c4d0
md"""
...
# ╔═╡ f71babb9-057d-4d3f-9275-093e2f613426
md"""
### `_cv_checkerboard`
"""

# ╔═╡ 19469875-249e-4c19-b268-59e195a72536
...
# ╔═╡ 2575d7aa-032d-405c-b004-9957013a59b1
checker = _cv_checkerboard(size(img), 5)

# ╔═╡ ad33de63-c534-46b1-8360-59e0533b7919
heatmap(checker, colormap=:grays)

# ╔═╡ 99ce3720-5664-4f86-a1bb-d4426c39ae73
md"""
### `_cv_curvature`
"""

# ╔═╡ d25e4a1e-339e-4c19-a75c-311b55ce747d
...
# ╔═╡ 186055b7-a1d2-4026-b59a-b3b04fa931a8
test_phi = [
	10 -100 10 190 20
	10 -100 10 -100 20
	10 -100 10 -100 20
...
# ╔═╡ 4d70d13b-72e5-4b7f-90f4-e35541833575
_cv_curvature(test_phi)

# ╔═╡ 50c7e8a0-7e49-4f7c-a1d5-c8652ba7ab8f
md"""
### `_cv_calculate_averages`
"""

# ╔═╡ 59fff410-28d0-408e-bbea-41a1b5f9f0a4
"""
...
# ╔═╡ a7ca9a12-85d6-49e7-91f1-fff527fd8ce1
test_Hphi = 1 * (test_phi .> 0)

# ╔═╡ 19e8dcc2-c4b6-4bc6-8e46-98a9332c06a8
test_image = [
	10 100 -10 0 10
	10 100 -10 0 10
	10 100 -10 0 10
...
# ╔═╡ 817a7edc-2a38-4eb7-a505-5e03b5cd805e
_cv_calculate_averages(test_image, test_Hphi)

# ╔═╡ 679f3f6e-4fe8-4e40-a451-623a1e895126
md"""
### `_cv_delta`
"""

# ╔═╡ 95a79795-4fbc-4958-b4ec-466bcb20e3a2
function _cv_delta(x, eps=1.0)
    eps ./ (eps.^2 .+ x.^2)
end

# ╔═╡ bf2583f2-1301-420e-9111-eae00f870df2
_cv_delta(test_phi)

# ╔═╡ 70b28902-d2f4-43b6-9e0a-c15f21a48cc1
md"""
### `_cv_calculate_variation`
"""

# ╔═╡ 773e2ba2-f2f6-4e6f-8392-3dd06ea6347d
"""
...
# ╔═╡ 1e568016-17ee-406a-81f4-437dc502b63e
begin
	test_mu = 0.25
	test_lambda1 = 1
	test_lambda2 = 1
...
# ╔═╡ 5a0276eb-b64c-48b8-8bd8-e1044afd7d08
_cv_calculate_variation(test_image, test_phi, test_mu, test_lambda1, test_lambda2, test_dt)

# ╔═╡ 93f0d072-9063-42f6-bc0c-e458ff436e9d
md"""
### `_cv_heavyside`
"""

# ╔═╡ 8ff24d32-2a61-40d1-a1bf-6535676209e0
"""
...
# ╔═╡ bb45e2e0-6108-4875-8634-37b3157cd4c8
_cv_heavyside(test_phi)

# ╔═╡ 4d566489-4c53-4dc4-b31f-31a58cabbc77
md"""
### `_cv_difference_from_average_term`
"""

# ╔═╡ 14c4a1be-ca7c-4cc0-89e8-0ace4c99080d
...
# ╔═╡ c56778c4-10af-4431-a8de-43aa59fef5a0
_cv_difference_from_average_term(test_image, test_Hphi, test_lambda1, test_lambda2)

# ╔═╡ b5301e2c-db22-4376-b931-b2accb4a2efc
md"""
### `_cv_edge_length_term`
"""

# ╔═╡ c3c2beff-7d00-496a-8993-7c5e3de11a44
function _cv_edge_length_term(phi, mu)
    toret = _cv_curvature(phi)
    return mu * toret
end

# ╔═╡ 0b4eb11c-fc17-40b3-87ec-87f64f172ef2
_cv_edge_length_term(test_phi, test_mu)

# ╔═╡ c9be9822-9f13-4e45-b2da-85f4c267f604
md"""
### `_cv_energy`
"""

# ╔═╡ 43d3d6d8-c195-49c0-9090-7cb6307fdaba
...
# ╔═╡ 34e9abff-ad47-4421-adde-ac1d991f6482
_cv_energy(test_image, test_phi, test_mu, test_lambda1, test_lambda2)

# ╔═╡ 4d88ae3d-dcda-4c4b-96b3-36797a027f21
md"""
## Run loop
"""

# ╔═╡ 97d9b47b-3cce-4437-bbf0-c65bf8b9453f
begin
	# hardcode parameters
	mu = 0.25
	lambda1 = 1
...
# ╔═╡ d4612fe0-8125-447b-8542-54ecff4ff7a8
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "c9209768cdcdb51bc25069577b4887604090a4b0"
